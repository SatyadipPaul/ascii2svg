...
IMAGES = [
    ...
    ("docs/examples/duckdb.txt", "docs/duckdb.svg", LIVE + ["--title", "How DuckDB runs a query"]),
    ("docs/examples/duckdb.txt", "docs/duckdb.html",
     ["--theme", "auto", "--color", "--animate", "scroll", "--title", "How DuckDB runs a query"]),
